...
//Credit https://github.com/omkarmoghe/Pokemap
public class MapHelper {
    ...
    private static final int SCAN_RADIUS = 70;
    private static final double DISTANCE_BETWEEN_CIRCLES = 150;
//            121; dont really need perfect coverage
